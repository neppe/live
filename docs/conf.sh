# This is a sample config file, refer to pippi-tv(5) for more information

# In the previous version of pippi-tv this file had all the examples, with all defaults set,
...
# we are now going to only have this sample config file, and the pippi-tv(5) manual, which has explanation of every variable and function that can be set.
